...
@section('content')
    ...
    <div class="row align-items-center mb-5"> 
        <div class="col-12 col-md-6 col-lg-6 p-5 text-black"> 
            ...
            <p>
                DraftoStation es un juego de colección y draft donde los jugadores seleccionan consolas de videojuegos 
                para colocarlas en distintos recintos de su tablero. 
                El objetivo es puntuar lo máximo posible utilizando la estrategia correcta para cada espacio.
            </p>
        </div>
    ...
    <div class="card shadow-lg border-0 mb-4">
        ...
        <div class="card-body">
            <p>
                En cada ronda, los jugadores eligen una consola de las que tienen en mano y pasan el resto al jugador siguiente. 
                Cada consola se debe colocar en un recinto de tu tablero, respetando sus condiciones.<br>
                Al final de la partida se suman los puntos de todos los recintos, más los de la Atari (T-Rex) si corresponde.
            </p>
        </div>
    </div>
      
    {{-- Reglas de los recintos --}}
    ...
    <div class="card shadow-lg border-0">
        ...
        <div class="card-body">
            <p>
                La partida termina cuando todas las consolas fueron colocadas.<br>
                Se suman los puntos de cada recinto, más la puntuación de la Atari.<br>
                El jugador con más puntos se convierte en el <strong>Maestro de DraftoStation</strong>.
            </p>
        </div>
    </div>
